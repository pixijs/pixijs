...
export class CanvasTextGeneratorClass
{
     ...
     *
     * This method handles:
     * - Setting the correct font and text style
     * - Applying drop shadows when enabled
     * - Rendering text with stroke and fill in the correct order
     * - Proper alignment of text (left, center, right)
     * - Letter spacing adjustments
     * @param text - The text to render to the canvas
     * @param style - The text style to apply
     * @param resolution - The resolution of the canvas
     * @param canvasAndContext - The canvas and context to render to
     * @private
     */
    private _renderTextToCanvas(text: string, style: TextStyle, resolution: number, canvasAndContext: CanvasAndContext): void
    {
