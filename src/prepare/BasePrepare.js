...
export default class BasePrepare
{
     ...
     *
     * @param {Function|PIXI.DisplayObject|PIXI.Container|PIXI.BaseTexture|PIXI.Texture|PIXI.Graphics|PIXI.Text} item - Either
     *        the container or display object to search for items to upload, the items to upload themselves,
