...
describe('Parse KTX', () =>
{
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'textures/test.astc.4x4.ktx'));
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'tests/compressed/textures/test.astc.ktx'));
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'tests/compressed/textures/test.astc.4x4.ktx'));
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'tests/compressed/textures/test.astc.5x5.ktx'));
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'tests/compressed/textures/test.astc.12x12.ktx'));
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'tests/compressed/textures/test.bc1.ktx'));
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'tests/compressed/textures/test.bc3.ktx'));
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'tests/compressed/textures/test.etc2.ktx'));
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'tests/compressed/textures/test.RGBA8.ktx'));
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync(path.resolve(__dirname, 'tests/compressed/textures/test.bc3.mipmap.ktx'));
        const arrayBuffer = toArrayBuffer(buffer);
