 ...
 * @internal
 */
export function serializeContainerExtensions(
    container: Container,
    node: Gl2dPixiNode,
...
)
{
    const input: Gl2dSerializerInput<Gl2dPixiNode['extensions']['pixi_container_node']> = {
        ...
        sortableChildren: gl2dUtils.checkValue(container.sortableChildren, PIXI_CONTAINER_DEFAULTS.sortableChildren),
        ...
        cullableChildren: gl2dUtils.checkValue(container.cullableChildren, PIXI_CONTAINER_DEFAULTS.cullableChildren),
