...
PIXI.Sprite = function(texture)
{
     ...
     * The default is 0,0 this means the texture's origin is its top left corner
     * Setting than anchor to 0.5,0.5 means the texture's origin is centered
     * Setting the anchor to 1,1 would mean the texture's origin points will be its bottom right corner
     *
     * @property anchor
     * @type Point
     */
...
/**
 * Retrieves the bounds of the sprite as a rectangle bound object 
 *
 * @method getBounds
 * @private
