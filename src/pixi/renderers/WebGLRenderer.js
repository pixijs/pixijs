...
PIXI.WebGLRenderer.updateTexture = function(texture)
{
	...
	if(texture.hasLoaded)
	{
		...
		gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, texture.filter === PIXI.BaseTexture.FILTER.LINEAR ? gl.LINEAR : gl.NEAREST);
		gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, texture.filter === PIXI.BaseTexture.FILTER.LINEAR ? gl.LINEAR : gl.NEAREST);
