...
PIXI.Spine = function(url)
{
    ...
    for (var i = 0, n = this.skeleton.drawOrder.length; i < n; i++) {
        ...
        slotContainer.addChild(this.createSprite(attachment.rendererObject));
    }
};
...
PIXI.Spine.prototype.updateTransform = function () {
    ...
    for (var i = 0, n = drawOrder.length; i < n; i++) {
        ...
        if (!slot.data.attachmentName && attachment.rendererObject) {
...
PIXI.Spine.prototype.createSprite = function(descriptor) {
