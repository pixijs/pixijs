...
export default class SpriteRenderer extends ObjectRenderer
{
    ...
    flush()
    {
        ...
        let uvs;
        let blendMode
            = premultiplyBlendMode[sprites[0]._texture.baseTexture.premultipliedAlpha ? 1 : 0][sprites[0].blendMode];
        ...
        for (i = 0; i < this.currentIndex; ++i)
        {
            ...
            float32View[index + 4] = float32View[index + 9] = float32View[index + 14] = float32View[index + 19]
        ...
        if (!settings.CAN_UPLOAD_SAME_BUFFER)
        {
            ...
            if (this.vaoMax <= this.vertexCount)
            {
                ...
                /* eslint-disable max-len */
                const vertexBuffer = (this.vertexBuffers[this.vertexCount] = glCore.GLBuffer.createVertexBuffer(
                    gl,
                    null,
                    gl.STREAM_DRAW
                ));
