...
export default class TextStyle
{
    ...
    /**
     * Generates a font style string to use for `TextMetrics.calculateFont(fontString)`.
     *
     * @return {string} Font style string, for passing to `TextMetrics.calculate(fontString)`
     */
    toFontString()
    {
