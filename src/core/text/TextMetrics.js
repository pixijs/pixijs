...
export default class TextMetrics
{
    ...
    static CJKWordLanguage(word)
    {
        ...
        // 3040 - 309F Hiragana -- Japanese only
        // 30A0 - 30FF Katakana -- Japanese only
        // 3100 - 312F Bopomofo -- Chinese
        // 3130 - 318F Hangul Compatibility Jamo (Korean)
        // 3190 - 319F Kanbun -- Chinese/Japanese kinda
        ...
        // 4DC0 - 4DFF Yijing Hexagram Symbols (China)
        // 4E00 - 9FAF CJK unified ideographs (Chinese, japanese, korean, vietnamese)
        // AC00 - D7AF Hangul Syllables (Korean)
        // A960 - A97F Hangul Jamo Extended-A (Korean)
        // D7B0 - D7FF Hangul Jamo extended B (Korean)
        // FE30 - FE4F CJK Compatibility forms
        // FF00 - FF9F Halfwidth and fullwidth forms -- (Chinese, Japanese, Korean)

        const jpnRegExp = new RegExp(`[\\u1100-\\u11ff\\u3130-\\u318f\\uac00-\\ud7af
            \\ua960-\\ua97f\\ud7b0-\\ud7ff]`);
    ...
    static CJKWordWrap(word, measureText, characterCache, wordWrapWidth)
    {
        ...
        const wordLanguage = TextMetrics.CJKWordLanguage(word);
    ...
    static wordWrap(text, style, canvas = TextMetrics._canvas)
    {
        ...
        for (let i = 0; i < lines.length; i++)
        {
            ...
            for (let j = 0; j < words.length; j++)
            {
                ...
                const wordLanguage = TextMetrics.CJKWordLanguage(words[j]);
