...
export { default as NewTexture } from './textures/BaseTexture';
export { default as NewFrameBuffer } from './textures/FrameBuffer';
export { default as NewCubeTexture } from './textures/CubeTexture';
