 ...
 * @memberof PIXI
 */
var ParticleShader = function (_GLShader) {
    _inherits(ParticleShader, _GLShader);
    ...
    function ParticleShader(gl) {
        ...
        return _possibleConstructorReturn(this, _GLShader.call(this, gl,
        // vertex shader
