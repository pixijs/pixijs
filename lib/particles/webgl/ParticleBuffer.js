...
var _GLBuffer = require('../../core/renderers/webgl/systems/geometry/GLBuffer');
...
var ParticleBuffer = function () {
    ...
    ParticleBuffer.prototype.initBuffers = function initBuffers() {
        ...
        this.dynamicBuffer = _GLBuffer2.default.createVertexBuffer(gl, this.dynamicData, gl.STREAM_DRAW);
        ...
        this.staticBuffer = _GLBuffer2.default.createVertexBuffer(gl, this.staticData, gl.STATIC_DRAW);
