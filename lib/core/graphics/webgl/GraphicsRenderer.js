...
var GraphicsRenderer = function (_ObjectRenderer) {
    ...
    function GraphicsRenderer(renderer) {
        ...
        _this.primitiveShader = new _PrimitiveShader2.default();
        _this.primitiveShader.uniforms.globals = renderer.globalUniforms;
    ...
    GraphicsRenderer.prototype.render = function render(graphics) {
        ...
        for (var i = 0, n = webGL.data.length; i < n; i++) {
            ...
            shader.uniforms.tint = (0, _utils.hex2rgb)(graphics.tint);
