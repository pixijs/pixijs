 ...
 * @memberof PIXI
 */
var MaskSystem = function (_WebGLSystem) {
    _inherits(MaskSystem, _WebGLSystem);
    ...
    MaskSystem.prototype.push = function push(target, maskData) {
        ...
        } else if (this.enableScissor && !this.scissor && this.renderer._activeRenderTarget.root && !this.renderer.stencil.stencilMaskStack.length && maskData.isFastRect()) {
