...
var FilterSystem = function (_WebGLSystem) {
    _inherits(FilterSystem, _WebGLSystem);
    ...
    FilterSystem.prototype.contextChange = function contextChange() {
        this.gl = this.renderer.gl;
        // know about sprites!
        this.quad = new _Quad2.default(this.gl, this.renderer.state.attribState);
    };
    ...
    FilterSystem.prototype.syncUniforms = function syncUniforms(shader, filter) {
    ...
    FilterSystem.prototype.getRenderTarget = function getRenderTarget(clear, resolution) {
    ...
    FilterSystem.prototype.returnRenderTarget = function returnRenderTarget(renderTarget) {
    ...
    FilterSystem.prototype.calculateScreenSpaceMatrix = function calculateScreenSpaceMatrix(outputMatrix) {
        var currentState = this.filterData.stack[this.filterData.index];
    ...
    FilterSystem.prototype.calculateNormalizedScreenSpaceMatrix = function calculateNormalizedScreenSpaceMatrix(outputMatrix) {
        var currentState = this.filterData.stack[this.filterData.index];
    ...
    FilterSystem.prototype.getPotRenderTarget = function getPotRenderTarget(gl, minWidth, minHeight, resolution) {
    ...
    FilterSystem.prototype.freePotRenderTarget = function freePotRenderTarget(renderTarget) {
