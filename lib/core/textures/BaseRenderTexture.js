...
var BaseRenderTexture = function (_BaseTexture) {
  ...
  function BaseRenderTexture() {
    ...
    var _this = _possibleConstructorReturn(this, _BaseTexture.call(this, null, scaleMode, resolution, width, height));
    ...
    _this.frameBuffer = new _FrameBuffer2.default(width, height).addColorTexture(0, _this)
  ...
  BaseRenderTexture.prototype.resize = function resize(width, height) {
    _BaseTexture.prototype.resize.call(this, width, height);
