...
var _CanvasResource = require('./resources/CanvasResource');
...
var Texture = function (_EventEmitter) {
    ...
    Texture.from = function from(source, scaleMode) {
        var cacheId = null;
        ...
        if (!texture) {
            texture = new Texture(new _BaseTexture2.default(source, scaleMode));
            texture.baseTexture.cacheId = cacheId;

            _BaseTexture2.default.addToCache(texture.baseTexture, cacheId);
    ...
    Texture.fromLoader = function fromLoader(source, imageUrl, name) {
        ...
        var resource = new _ImageResource2.default(source); // .from(imageUrl, crossorigin);// document.createElement('img');

        resource.url = imageUrl;

        //  console.log('base resource ' + resource.width);
        var baseTexture = new _BaseTexture2.default(resource, _settings2.default.SCALE_MODE, (0, _utils.getResolutionOfUrl)(imageUrl));
...
function createWhiteTexture() {
    ...
    return new Texture(new _BaseTexture2.default(new _CanvasResource2.default(canvas)));
}
