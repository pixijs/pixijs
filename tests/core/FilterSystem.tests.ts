...
// note: Lots of renderer API differences
...
//     beforeAll(async () =>
//     {
//         renderer = await getRenderer() as WebGLRenderer;
//     });
...
//     {
//         const innerFilter = new Filter(); // <-- note: options were not optional, updated Filter constructor
