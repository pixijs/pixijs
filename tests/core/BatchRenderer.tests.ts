// note: is BatchRenderer now Batcher? Non compatible API in tests
...
//         return new Texture(new CanvasSource({ resource: canvas }));
//     }
...
//     it('should pass the batching test', async () =>
//     {
