...
// describe('Geometry', () =>
// {
//     it('should dispose shared index buffer after all geometries were disposed/destroyed', async () =>
//     {
//         const renderer = await getRenderer({ width: 1, height: 1 });
...
//             const prog = new GlProgram({ vertex: vert, fragment: frag });
...
//     it('should dispose buffer if geometry is used by two shaders', async () =>
//     {
//         const renderer = await getRenderer({ width: 1, height: 1 });
...
//     it('should create one VAO for shaders with the same attributes and same location specifiers', async () =>
//     {
//         const renderer = await getRenderer({ width: 1, height: 1 });
...
//     it('should create different VAOs for shaders with the same attributes but different location specifiers', async () =>
//     {
//         const renderer = await getRenderer({ width: 1, height: 1 });
...
//     it('should create compatible VAOs if GeometrySystem.checkCompatibility is disabled', async () =>
//     {
//         const renderer = await getRenderer({ width: 1, height: 1 });
