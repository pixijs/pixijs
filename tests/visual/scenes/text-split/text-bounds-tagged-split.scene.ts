...
export const scene: TestScene = {
    it: 'should render bounds with tagged text correctly using split text',
    options: {
        width: 164,
        height: 64,
    },
    create: async (scene: Container) =>
    {
        ...
        splitResult.position.x = 10 + (splitResult.width / 2);
        splitResult.position.y = (splitResult.height / 2);
