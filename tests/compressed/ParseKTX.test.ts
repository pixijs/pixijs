...
import { parseKTX } from '../../src/compressed-textures/ktx/parseKTX';

describe('Parse KTX', () =>
{
    it('should throw Error Unsupported texture format', async () =>
    {
        const buffer = readFileSync('./tests/compressed/textures/test.astc.4x4.ktx');
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.astc.ktx');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.astc.5x5.ktx');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.astc.12x12.ktx');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.bc1.ktx');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.bc3.ktx');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.etc2.ktx');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.RGBA8.ktx');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.bc3.mipmap.ktx');
        const arrayBuffer = toArrayBuffer(buffer);
