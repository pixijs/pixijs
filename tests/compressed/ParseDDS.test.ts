...
import { parseDDS } from '../../src/compressed-textures/dds/parseDDS';

describe('Parse DDS', () =>
{
    it('should throw Error Unsupported texture format', async () =>
    {
        const buffer = readFileSync('./tests/compressed/textures/test.dxt1.dds');
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.dxt1.mipmap.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.dxt3.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.dxt3.mipmap.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.dxt5.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.dxt5.mipmap.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.bc4.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.bc4.mipmap.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.bc5.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.bc5.mipmap.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.bc7.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.rgba8.dds');
        const arrayBuffer = toArrayBuffer(buffer);
    ...
    {
        const buffer = readFileSync('./tests/compressed/textures/test.rgba8.mipmap.dds');
        const arrayBuffer = toArrayBuffer(buffer);
