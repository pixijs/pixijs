import { BaseTexture, Renderer, RenderTexture, Texture, VideoResource } from '@pixi/core';
import { Sprite } from '@pixi/sprite';
import { detectVideoAlphaMode } from '@pixi/utils';
...
describe('detectVideoAlphaMode', () =>
{
    it('should detect the correct alpha mode for video textures', async () =>
    {
        ...
        const resource = new VideoResource(video);

        await resource.load();

        const texture = new Texture(new BaseTexture(resource));

        texture.baseTexture.alphaMode = await detectVideoAlphaMode();
