...
describe('PIXI.SimplePlane', function ()
{
    ...
    it('should create a new empty textured SimplePlane', withGL(function ()
    {
    ...
    {
        it('should return true when point inside', withGL(function ()
        {
        ...
        it('should return false when point outside', withGL(function ()
        {
