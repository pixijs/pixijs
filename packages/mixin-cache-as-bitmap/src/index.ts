...
DisplayObject.prototype._initCachedDisplayObject = function _initCachedDisplayObject(renderer: Renderer): void
{
    ...
    const bounds = (this as Container).getLocalBounds(null).clone();
...
): void
{
    ...
    const bounds = (this as Container).getLocalBounds(null);
...
DisplayObject.prototype._calculateCachedBounds = function _calculateCachedBounds(): void
{
    ...
    this._bounds.minX = this._cacheData.sprite._bounds.minX;
    this._bounds.minY = this._cacheData.sprite._bounds.minY;
    this._bounds.maxX = this._cacheData.sprite._bounds.maxX;
    this._bounds.maxY = this._cacheData.sprite._bounds.maxY;
};
