...
import { BaseTexture, Texture, BufferResource } from '@pixi/core';
import { INTERNAL_FORMATS, CompressedTextureResource } from '@pixi/compressed-textures';
...
var BASIS_FORMAT_TO_INTERNAL_FORMAT = (_a = {},
    _a[BASIS_FORMATS.cTFETC1] = INTERNAL_FORMATS.COMPRESSED_RGB_ETC1_WEBGL,
    _a[BASIS_FORMATS.cTFBC1] = INTERNAL_FORMATS.COMPRESSED_RGB_S3TC_DXT1_EXT,
    _a[BASIS_FORMATS.cTFBC3] = INTERNAL_FORMATS.COMPRESSED_RGBA_S3TC_DXT5_EXT,
    _a[BASIS_FORMATS.cTFPVRTC1_4_RGB] = INTERNAL_FORMATS.COMPRESSED_RGB_PVRTC_4BPPV1_IMG,
    _a[BASIS_FORMATS.cTFPVRTC1_4_RGBA] = INTERNAL_FORMATS.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG,
    _a[BASIS_FORMATS.cTFATC_RGB] = INTERNAL_FORMATS.COMPRESSED_RGB_ATC_WEBGL,
    _a[BASIS_FORMATS.cTFASTC_4x4] = INTERNAL_FORMATS.COMPRESSED_RGBA_ATC_INTERPOLATED_ALPHA_WEBGL,
    _a);
/**
...
var BASIS_FORMAT_TO_TYPE = (_b = {},
    _b[BASIS_FORMATS.cTFRGBA32] = TYPES.UNSIGNED_BYTE,
    _b[BASIS_FORMATS.cTFRGB565] = TYPES.UNSIGNED_SHORT_5_6_5,
    _b[BASIS_FORMATS.cTFRGBA4444] = TYPES.UNSIGNED_SHORT_4_4_4_4,
    _b);
/**
...
var BASIS_FORMATS_ALPHA = (_c = {},
    _c[BASIS_FORMATS.cTFBC3] = true,
    _c[BASIS_FORMATS.cTFPVRTC1_4_RGBA] = true,
    _c[BASIS_FORMATS.cTFASTC_4x4] = true,
    _c);
...
var BasisLoader = /** @class */ (function () {
    ...
    BasisLoader.registerTextures = function (url, resources) {
        ...
        var format = resources.basisFormat !== BASIS_FORMATS.cTFRGBA32 ? FORMATS.RGB : FORMATS.RGBA;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!fallbackMode) {
                            ...
                            imageResources = imageArray.map(function (image) { return new BufferResource(new Uint16Array(image.levelArray[0].levelBuffer.buffer), {
                                width: image.width,
                                height: image.height
                            }); });
                        }
    ...
    BasisLoader.transcodeSync = function (arrayBuffer) {
        ...
        for (var i = 0; i < imageCount; i++) {
            ...
            if (!fallbackMode) {
                ...
                imageResource = new BufferResource(new Uint16Array(imageLevels[0].levelBuffer.buffer), { width: width, height: height });
            }
...
export { BASIS_FORMATS, BASIS_FORMATS_ALPHA, BASIS_FORMAT_TO_INTERNAL_FORMAT, BASIS_FORMAT_TO_TYPE, BasisLoader, INTERNAL_FORMAT_TO_BASIS_FORMAT };
//# sourceMappingURL=basis.es.js.map
