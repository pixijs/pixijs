...
export class ParticleRenderer extends ObjectRenderer
{
    ...
    render(container)
    {
        ...
        this.renderer.state.setBlendMode(correctBlendMode(container.blendMode, baseTexture.pmaMode));
        ...
        this.shader.uniforms.uColor = premultiplyRgba(container.tintRgb,
            container.worldAlpha, this.shader.uniforms.uColor, baseTexture.pmaMode);
    ...
    uploadTint(children, startIndex, amount, array, stride, offset)
    {
        ...
        {
            const sprite = children[startIndex + i];
            const premultiplied = sprite._texture.baseTexture.pmaMode > 0;
