...
export class BitmapFont
{
     ...
     * kernings yet.
     *
     * @param {PIXI.IBitmapFontOptions|string} options - Setup options for font or name of the font.
     * @param {string} options.name - Name of the font to automatically install.
     ...
     * @param {number} [options.resolution=1] - Optional render resolution for glyphs.
     * @param {number} [options.textureWidth=2048] - Optional width of cache texture, smaller values to reduce memory.
     * @param {number} [options.textureHeight=2048] - Optional height of cache texture, smaller values to reduce memory.
     * @param {number} [options.padding=4] - Padding between glyphs on cache texture.
     ...
     */
    public static from(options: IBitmapFontOptions | string, textStyle?: TextStyle | Partial<ITextStyle>): BitmapFont
    {
 ...
 * @property {string} name - name of the font to auto-install
