...
export class RenderTexture extends Texture
{
    ...
    resize(desiredWidth: number, desiredHeight: number, resizeBaseTexture = true): void
    {
        ...
        const width = Math.round(desiredWidth * baseTexture.resolution) / baseTexture.resolution;
        const height = Math.round(desiredHeight * baseTexture.resolution) / baseTexture.resolution;
