...
export default class ShaderSystem extends System
{
    ...
    constructor(renderer)
    {
        ...
        /**
         * Cache to holds the generated functions. Stored against UniformObjects unique signiture
         * @type {Object}
         * @private
         */
        this.cache = {};
    ...
    /**
     * Takes a uniform group and data and generates a unique signiture for them.
     *
     * @param {PIXI.UniformGroup} group the uniform group to get signiture of
     * @param {Object} uniformData uniform information generated by the shader
     * @returns {String} Unique signiture of the uniform group
     * @private
     */
