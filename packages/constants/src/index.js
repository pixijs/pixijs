...
export const TYPES = {
    ...
    /**
     * Returns if any type in the `TYPES` enum is of integer
     * nature.
     *
     * @param {number} glint - `TYPES` types
     * @return if `glint` is an integral type
     */
    isInteger(glint)
    {
        return (glint !== TYPES.FLOAT) && (glint !== TYPES.HALF_FLOAT);
    },
